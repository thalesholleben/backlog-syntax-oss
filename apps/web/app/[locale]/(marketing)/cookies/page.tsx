...
export async function generateMetadata() {
  ...
  return localizeMetadata(
    marketingMetadata({
      title: "Cookies",
      description: t("Cookies necessários para autenticação e segurança no Backlog Syntax."),
      path: "/cookies",
    }),
    locale,
  );
...
const sections = (t: Translator) =>
  [
    {
      heading: t("O site usa cookies hoje?"),
      content: (
        <p>
          {t(
    ...
    {
      heading: t("Como funciona o cookie de sessão?"),
      content: (
        <p>
          {t("O login usa o cookie necessário")} <code>__Host-backlog_session</code>
          {t(", com")}
          <code> Secure</code>, <code>HttpOnly</code>, <code>SameSite=Lax</code> {t("e")}
          <code> Path=/</code>
          {t(", restrito ao host da API, sem atributo")} <code>Domain</code>
          {t(
    ...
    {
      heading: t("Quando haverá banner de consentimento?"),
      content: (
        <p>
          {t(
