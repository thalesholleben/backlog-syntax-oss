    ...
    <section className="space-y-6">
      ...
      {contextQuery.isLoading || !summary ? (
        ...
        <div className="max-w-sm space-y-4 rounded-card border border-line bg-surface p-5">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.1em] text-muted">Seu papel</p>
      ...
      <p className="max-w-sm text-sm text-muted">
        Renomear workspace e transferir titularidade ainda não têm endpoint definido; esta seção só
