...
export const english = {
  ...
  ...{
    ...
    "A Syntax Lab, CNPJ 61.779.209/0001-90, opera o Backlog Syntax. Thales Gomes é o responsável pelo produto. O canal para privacidade é contato@syntaxlab.com.br. A Syntax Lab decide sobre dados de conta e segurança; no conteúdo inserido em workspaces, o papel de controlador depende de quem define a finalidade de uso e inclui o responsável pelo workspace.":
      "Syntax Lab, Brazilian company registration (CNPJ) 61.779.209/0001-90, operates Backlog Syntax. Thales Gomes is responsible for the product. The privacy contact is contato@syntaxlab.com.br. Syntax Lab determines the purposes of account and security data processing. For content entered into workspaces, the controller role depends on who determines its purpose and includes the workspace owner.",
