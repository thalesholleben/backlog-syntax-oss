...
INSERT INTO domain.rate_limits
  (tenant_id, subject_type, subject_id, bucket, window_started_at)
VALUES
  ('01990000-0000-7000-8000-000000000001', 'user', '01990000-0000-7000-8000-000000000101', 'task-queue', now()),
  ('01990000-0000-7000-8000-000000000002', 'user', '01990000-0000-7000-8000-000000000102', 'task-queue', now())
ON CONFLICT DO NOTHING;
